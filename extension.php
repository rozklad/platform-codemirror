...
return [
	...
	*/
	...
	{
		Route::group([
				'prefix'    => admin_uri().'/codemirror',
				'namespace' => 'Sanatorium\Codemirror\Controllers\Admin',
			], function()
			{
				Route::get('/{route?}' , ['as' => 'admin.sanatorium.codemirror.get', 'uses' => 'CodemirrorsController@get'])
					->where('route', '(.*)');
		});
	},
